...
#define STRING_CONFIG_H_AUTHOR "(Jerome Paul)" // Who made the changes.
...
#define MACHINE_UUID "ffad5ec8-1933-41d6-a241-f902ff41b256"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Ki   8.16
    #define DEFAULT_Kd 123.60
  #endif
#endif
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 125.99
  #define DEFAULT_bedKi 15.69
  #define DEFAULT_bedKd 674.30
